                                                                    ...
                                                                    <div class="col-lg-5" >
                                                                        ...
                                                                        <div class="card-header">
                                                                            <div class="form-group d-flex justify-content-between">
                                                                             ...
                                                                             <h2 class="texts text-center " style="font-size:20px;"> Your account is under review.  <br /> You will receive a notification once your account is approved. <br />Please check your notification from time to time. </h2> 
                                                                        </div> 
                                                                            <div class="card" id="reminderStatus"> <br />
                                                                                <h7 class="text-center " style="font-size:18px;">Reminder:</h7> <br>
                                                                               <h7 class="text-center " style="font-size:16px;"> " You can't proceed with the subscription yet since your account is under review. <br /> Please wait for your account to be approved before subscribing" </h7> 
                                                                            </div>
                                                                         <!-- cancel button -->
