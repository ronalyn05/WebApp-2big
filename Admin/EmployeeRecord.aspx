                                                                    ...
                                                                    <div class="col-md-12 col-sm-12 ">
                                                                        <div class="x_content">
                                                                             <div class="col-md-12 col-sm-12 ">
                                                                                 ...
                                                                                 <asp:RequiredFieldValidator ID="reqlname" runat="server" ErrorMessage="***" ForeColor="Red" Font-Bold="true" ControlToValidate="txtlastname" ></asp:RequiredFieldValidator>
                                                                             </div>
                                                                              <div class="col-md-12 col-sm-12">
                                                                                  <%--firstname--%>
                                                                                  <strong>Firstname:</strong>
                                                                                  <asp:TextBox ID="txtfirstname" runat="server" class="form-control" placeholder="Employees' Firstname"></asp:TextBox>
                                                                                  <asp:RequiredFieldValidator ID="reqfname" runat="server" ErrorMessage="***" ForeColor="Red" Font-Bold="true" ControlToValidate="txtfirstname" ></asp:RequiredFieldValidator>
                                                                              </div>
                                                                              ...
                                                                              <div class="col-md-12 col-sm-12">
                                                                                  ...
                                                                                  <strong>Date of Birth:</strong>
                                                                                    <asp:TextBox ID="BirthDate" runat="server" class="form-control" TextMode="Date" onchange="validateBirthDate()"> </asp:TextBox>
                                                                                      ...
                                                                                      <asp:RequiredFieldValidator ID="reqdob" runat="server" ErrorMessage="***" ForeColor="Red" Font-Bold="true" ControlToValidate="BirthDate"></asp:RequiredFieldValidator>    
                                                                               ...
                                                                               <div class="col-md-12 col-sm-12">
                                                                                   ...
                                                                                   <strong>Address:</strong>
                                                                                       ...
                                                                                       <asp:RequiredFieldValidator ID="reqaddress" runat="server" ErrorMessage="***" ForeColor="Red" Font-Bold="true" ControlToValidate="txtaddress" ></asp:RequiredFieldValidator> 
                                                                                  <%-- </div>--%>
                                                                               </div>
                                                                               ...
                                                                               <div class="col-md-12 col-sm-12">
                                                                                   ...
                                                                                   <strong>Contact Number:</strong>
                                                                                       ...
                                                                                       <asp:RequiredFieldValidator ID="reqcontact" runat="server" ErrorMessage="***" ForeColor="Red" Font-Bold="true" ControlToValidate="txtcontactnum" ></asp:RequiredFieldValidator> 
                                                                                   <%--</div>--%>
                                                                               </div>
                                                                               ...
                                                                               <div class="col-md-12 col-sm-12">
                                                                                   ...
                                                                                   <strong>Email Address:</strong>
                                                                                       ...
                                                                                       <asp:RequiredFieldValidator ID="reqemail" runat="server" ErrorMessage="***" ForeColor="Red" Font-Bold="true" ControlToValidate="txtemail"></asp:RequiredFieldValidator>
                                                                                  <%-- </div>--%>
                                                                               </div>
                                                                              <div class="col-md-12 col-sm-12">
                                                                                      <%-- email--%>
                                                                                   <strong>Password:</strong>
                                                                                       ...
                                                                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="***" ForeColor="Red" Font-Bold="true" ControlToValidate="txtpass" ></asp:RequiredFieldValidator>
                                                                                  <%-- </div>--%>
                                                                              </div>
                                                                               <div class="col-md-12 col-sm-12">
                                                                                      <%-- date hired--%>
                                                                                   <strong>Date Hired:</strong>
                                                                                       ...
                                                                                       <asp:RequiredFieldValidator ID="reqdoh" runat="server" ErrorMessage="***" ForeColor="Red" Font-Bold="true" ControlToValidate="txtdateHired"></asp:RequiredFieldValidator>
                                                                               ...
                                                                               <div class="col-md-12 col-sm-12">
                                                                                   ...
                                                                                   <strong>In case of emergency, Contact:</strong>
                                                                                       ...
                                                                                       <asp:RequiredFieldValidator ID="reqemercontact" runat="server" ErrorMessage="***" ForeColor="Red" Font-Bold="true" ControlToValidate="txtemergencycontact"></asp:RequiredFieldValidator>
                                                                                 </div>
                                                                                ...
                                                                                <div class="col-md-12 col-sm-12">
                                                                                        ...
                                                                                        <strong>Status:</strong>
                                                                                         ...
                                                                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="***" ForeColor="Red" Font-Bold="true" ControlToValidate="Drd_status"></asp:RequiredFieldValidator>
                                                                                  </div>   <br />
                                                                              </div>
                                                                        </div>
                                                                    </div>
                                                          ...
                                                          <div class="modal-content">
                                                              <div id="demo-form3" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                                                                  ...
                                                                  <div class="modal-body">
                                                                      ...
                                                                      <asp:Button ID="btnUpdateRecord" runat="server" Text="Edit Record" class="btn btn-primary btn-sm" ValidationGroup="a" OnClick="btnUpdateEmpRecord_Click"/>
                                                                      </div>
                                                                  </div>
                                                               </div>
                                                          </div>
