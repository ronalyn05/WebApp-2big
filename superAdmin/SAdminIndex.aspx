<%@ Page Title="" Language="C#" MasterPageFile="~/WRSsuperAdmin.Master" AutoEventWireup="true" CodeBehind="SAdminIndex.aspx.cs" Inherits="WRS2big_Web.superAdmin.SAdminIndex" %>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-footer bg-c-purple">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0 text-center"> SUBSCRIPTION SALES</p>
                                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-footer bg-c-green">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0 text-center">SUBSCRIBED CLIENTS</p>
                                                            </div>
                                                            <div class="col-3 text-right">
                                                                <i class="fa fa-line-chart text-white f-16"></i>
                                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-footer bg-c-red">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0 text-center"> PENDING CLIENTS</p>
                                                            </div>
                                                            <div class="col-3 text-right">
                                                                <i class="fa fa-line-chart text-white f-16"></i>
                                                            </div>
