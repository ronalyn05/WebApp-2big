<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfirmResetPass.aspx.cs" Inherits="WRS2big_Web.LandingPage.ConfirmResetPass" %>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <div class="col-lg-7 mb-10 mb-lg-0" style="margin-left: 250px; background-color: lightblue">
                        <br />
                        <center>
                            <h6 class="h6-mktg">Reset Password</h6>
                        </center>
                            ...
                            <div class="height-full position-relative rounded-3 px-2 pt-5 pb-2 js-pricing-plan">
                                <div class="d-md-flex flex-column flex-justify-between height-full rounded-3 color-shadow-extra-large color-bg-default">
                                    ...
                                    <div class="px-1 pt-1 pb-3">
                                        ...
                                        <asp:Label class="mb-2 h5-mktg" ID="packageName" runat="server"> Enter your new password </asp:Label>
                                        <br />
                                        <br />
                                        <center>
                                            <div class="input-group-sm">
                                                ...
                                                <asp:TextBox runat="server" class="form-control" Style="font-size: 18px" Width="450px" ID="newPassword" Placeholder="New Password" TextMode="Password"></asp:TextBox>
                                                <br />
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*_#?&]{8,20}$"
                                                    runat="server" ErrorMessage="Password must be 8-20 characters long and contain at least 1 letter, 1 number, and 1 special character except underscore(_) " ForeColor="Red" ControlToValidate="newPassword"></asp:RegularExpressionValidator>
                                            </div>
                                        </center>
                                        ...
                                        <center>
                                            <div class="col text-center">
                                                <asp:LinkButton ID="resetPass" class="btn-mktg d-block btn-muted-mktg" runat="server" OnClick="resetPass_Click" Text="Reset Password" />
                                                <br />
                                                <asp:LinkButton ID="cancelBtn" href="Account.aspx" class="btn-mktg d-block btn-muted-mktg" runat="server" Text="Cancel" />
