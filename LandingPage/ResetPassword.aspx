<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="WRS2big_Web.LandingPage.ResetPassword" %>
                                    ...
                                    <div class="px-1 pt-1 pb-3">
                                        ...
                                        <center>
                                         <div class="input-group-sm">
                                              <asp:TextBox runat="server"  class="form-control" style="font-size:18px" Width="450px" ID="enteredEmail" Placeholder="Registered Email "></asp:TextBox> <br /> 
                                             <asp:TextBox runat="server"  class="form-control" style="font-size:18px" Width="450px" TextMode="Number" ID="enteredPhone" Placeholder="Registered phonenumber"></asp:TextBox>
                                           </div>
                                        </center>
                                        ...
                                        <center>
                                            <div class="col text-center">
                                                <asp:LinkButton ID="submitBtn" OnClick="checkKey_Click" class="btn-mktg d-block btn-muted-mktg" runat="server" Text="Submit" /> <br />
