<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmailVerification.aspx.cs" Inherits="WRS2big_Web.LandingPage.EmailVerification" %>
...
<body themebg-pattern="theme1">
    <form id="form1" runat="server">
        <section>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4">
                    <div class="col-lg-10 mb-15 mb-lg-0" style="margin-left: 250px; background-color: lightblue">
                        <br />
                        <center>
                              <h6 class="h6-mktg">EMAIL VERIFICATION</h6>
                        </center>
 ...
 <img src="/images/emailverify.png" style="width: 500px" alt="logo.png"> <br />
                                        <asp:Label class="mb-2 h5-mktg" ID="packageName" runat="server"> Thankyou for Signing-up ! <br /> We have sent you an email to verify your account. Please check your email for the Verification Code <br /> <br /> Enter the verification code below: </asp:Label>
                                        <br />
                                        <br />
                                        <center>
                                         <div class="input-group-sm">
                                              <asp:TextBox runat="server"  class="form-control" style="font-size:18px" Width="450px" ID="enteredCode" Placeholder="Verification Code: "></asp:TextBox> <br /> 
                                           </div>
                                        </center>
